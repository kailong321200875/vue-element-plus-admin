<script lang="tsx">
  ...
  export default defineComponent({
    ...
    props: {
      ...
      load: {
        type: Function as PropType<
          (row: Recordable, treeNode: any, resolve: (data: Recordable[]) => void) => void
        >,
        default: undefined
      },
      treeProps: {
    ...
    setup(props, { attrs, emit, slots, expose }) {
      ...
      const setProps = (props: TableProps = {}) => {
        Object.assign(mergeProps.value, props)
      ...
      const renderTreeTableColumn = (columnsChildren: TableColumn[]) => {
        ...
        return columnsChildren.map((v) => {
          ...
          const slots = {
            default: (...args: any[]) => {
              const data = args[0]
              const isPreview = imagePreview.some((item) => item === v.field)
              ...
              return children && children.length
                ...
                : props?.slots?.default
                  ...
                  : v?.formatter
                    ...
                    : isPreview
                      ? renderImagePreview(get(data.row, v.field))
